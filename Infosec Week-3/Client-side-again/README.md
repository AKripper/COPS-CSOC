...
## Writeup
The link directs to a verification portal, but the site is not of much interest to us, So I checked the source code of of the page. It contains the following script:
```
...
This is the code in a readable manner.
